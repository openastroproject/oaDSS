...
#pragma omp parallel for schedule(dynamic, 50) default(none) firstprivate(ahdVariables) shared(height,pColorBitmap,pGrayInputBitmap,rgbToLab,width,progressCallback) if(nrProcessors > 1)
