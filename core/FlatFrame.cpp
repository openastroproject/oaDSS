...
#pragma omp parallel for schedule(static, 100) default(none) shared(height,bUseGray,pTarget,bUseCFA,width,pProgress,rowProgress,nrProcessors) if(nrProcessors > 1)
