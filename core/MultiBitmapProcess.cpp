...
#pragma omp parallel for default(none) shared(stop,progress,nrProcessors,nrRows,nrBitmaps) firstprivate(scanLines, avxOutputComposition) if(nrProcessors > 1 && nrRows > 1) // No "schedule" clause gives fastest result.
